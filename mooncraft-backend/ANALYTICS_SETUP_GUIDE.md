...
mysql -h localhost -u root -p -e "SHOW DATABASES LIKE 'mooncraft';"
```

**Solution:**
- Start MySQL service
- Update `.env` with correct credentials
- Create database if missing: `CREATE DATABASE mooncraft;`
...
CORS_ORIGIN=https://mooncraft-frontend.com
...
npm install -g pm2
pm2 start server.js --name "mooncraft-api"
pm2 logs mooncraft-api
