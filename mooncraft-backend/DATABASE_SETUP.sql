-- Create Database
CREATE DATABASE IF NOT EXISTS mooncraft_jewelry CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
SELECT 'Users Table' as 'Status', COUNT(*) as 'Columns' FROM information_schema.COLUMNS WHERE TABLE_SCHEMA = 'mooncraft_jewelry' AND TABLE_NAME = 'users'
UNION
SELECT 'Refresh Tokens Table', COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA = 'mooncraft_jewelry' AND TABLE_NAME = 'refresh_tokens'
UNION
SELECT 'User Addresses Table', COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA = 'mooncraft_jewelry' AND TABLE_NAME = 'user_addresses'
UNION
SELECT 'Categories Table', COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA = 'mooncraft_jewelry' AND TABLE_NAME = 'categories';
