...
WHERE TABLE_SCHEMA = 'mooncraft' AND TABLE_NAME LIKE '%payment%' OR TABLE_NAME LIKE '%wallet%' OR TABLE_NAME LIKE '%refund%' OR TABLE_NAME LIKE '%dispute%' OR TABLE_NAME LIKE '%installment%' OR TABLE_NAME LIKE '%payment_methods%' OR TABLE_NAME LIKE '%wallets%' OR TABLE_NAME LIKE '%saved_payment%';
