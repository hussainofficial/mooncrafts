...
**Issue**: Profile page not showing full MOONCRAFT header with navigation
...
```
┌─────────────────────────────────────────────────────┐
│ MOONCRAFT  Home Products Collections  ❤️ 🛒 [U]      │  ← Full Header
├─────────────────────────────────────────────────────┤
...
**Header Should Show:**
- ✅ MOONCRAFT logo (clickable, goes home)
...
3. Should see: [MOONCRAFT] [Home] [Products] [Collections] ... [❤️] [🛒] [U]
...
```
┌─────────────────────────────────────┐
│ MOONCRAFT  Menu Items  ❤️ 🛒 [U]      │  ← SAME HEADER
├─────────────────────────────────────┤
│ My Profile                          │
├─────────────────────────────────────┤
│ [Profile Content]                   │
...
✅ Full MOONCRAFT header with logo
