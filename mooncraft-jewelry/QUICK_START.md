# MOONCRAFT Jewelry - Quick Start Guide
...
```bash
npm run build
# Output: dist/mooncraft-jewelry/

# Serve production build locally
cd dist/mooncraft-jewelry
...
- **mooncraft_users** - User accounts
- **mooncraft_auth** - Current login session
- **mooncraft_products** - Product database
- **mooncraft_cart** - Shopping cart
- **mooncraft_wishlist** - Wishlist items
