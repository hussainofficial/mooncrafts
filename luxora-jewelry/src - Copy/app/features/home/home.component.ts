...
@Component({
  ...
  template: `
    ...
    <div *ngIf="showCartDrawer()" class="fixed inset-0 bg-black/50 z-50">
      <div class="absolute right-0 top-0 h-full w-full max-w-md bg-white shadow-lg overflow-y-auto">
        <!-- Header -->
        ...
        <div class="p-4">
          ...
          <div *ngIf="cartService.getCartItems().length > 0" class="space-y-4">
            ...
            <div class="border-t pt-4 mt-4">
              ...
              <!-- Checkout Button -->
              <button class="w-full bg-rose-500 text-white py-3 rounded-lg font-semibold hover:bg-rose-600 mb-2">
                Proceed to Checkout
              </button>
